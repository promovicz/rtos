...
LOGOMATICOBJS=board/logomatic/board.o board/logomatic/microsd.o
...
OBJS=start.o $(COREOBJS) $(LPCOBJS) $(CMDOBJS) $(LOGOMATICOBJS) $(POSIXOBJS) $(SENSOROBJ) $(POSIXSYS) $(DISARMOBJS) $(FATOBJS) main.o serial_fifo.o vcom.o
