...
POSIXOBJS=posix/file.o posix/process.o
OBJS=start.o $(COREOBJS) $(LPCOBJS) $(CMDOBJS) $(LOGOMATICOBJS) $(POSIXOBJS) halsys.o main.o serial_fifo.o armVIC.o console.o nmea.o vcom.o scp.o parse.o
