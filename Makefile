...
COREOBJS=core/tick.o core/tty.o core/parse.o
...
POSIXOBJS=posix/file.o posix/process.o posix/file_console.o
OBJS=start.o $(COREOBJS) $(LPCOBJS) $(CMDOBJS) $(LOGOMATICOBJS) $(POSIXOBJS) halsys.o main.o serial_fifo.o armVIC.o nmea.o vcom.o scp.o
